...
class Hospital extends Building {
    ...
    distributeLunch(patients) {
        let mealsPerDay = patients * 3;
...
class Cinema extends Building {
    ...
    projectSession(attendants, ticketPrice) {
        let total = attendants * ticketPrice;;
...
class Hotel extends Building {
    ...
    roomsCleaning(rooms) {
        let employee = Math.floor(rooms / 20) + 1;
